...
def main():
    ...
    swat_freq_list = ['P1_FIT101', 'P1_LIT101', 'P1_MV101', 'P1_P101',  'P2_AIT201','P2_AIT202', 'P2_AIT203', 'P2_FIT201', 'P2_MV201', 'P2_P201',
      'P2_P203',  'P2_P205', 'P3_DPIT301', 'P3_FIT301', 'P3_LIT301', 'P3_MV301', 'P3_MV302', 'P3_MV303', 'P3_MV304',
      'P3_P302', 'P4_AIT401', 'P4_AIT402', 'P4_FIT401', 'P4_LIT401', 'P5_AIT501', 'P5_AIT502', 'P5_AIT503', 'P5_AIT504', 'P5_FIT501', 'P5_FIT502',
      'P5_FIT503', 'P5_FIT504',  'P5_PIT501', 'P5_PIT502', 'P5_PIT503', 'P6_FIT601', 'P6_P601', 'P6_P602']
...
#     args.swat_freq_select_list = ['P1_LIT101', 'P1_MV101', 'P1_P101' ,'P2_P203', 'P3_DPIT301', 'P3_LIT301','P3_MV301','P4_LIT401', 'P5_AIT503']
    ...
    freq_selected_dim = [0,1,2,3]
    
    swat_n_cluster_list = list(np.arange(5,8))
    ...
    freq_list = []
    freq_list.extend(list(combinations(swat_freq_list, 4)))

    log.info('%s:%s:%s\n'%(datetime.datetime.now().hour, datetime.datetime.now().minute, datetime.datetime.now().second))


    train_x_swat, train_y_swat, val_x_swat, val_y_swat, test_x_swat, test_y_swat, feature_name_swat = SWaT_dataset(data_path = swat_dic['data_path'], read_size = args.read_size)

    for freq_num in range(len(freq_list)):
        log.info('freq is {}'.format(list(freq_list[freq_num])))
        log.info('\n\n')
    
        train_x_swat_freq = get_freq_data_2(data = train_x_swat, 
                        freq_select_list = list(freq_list[freq_num]), read_size = args.read_size,
        ...
        swat_n_cluster_list = list(np.arange(5,15))
